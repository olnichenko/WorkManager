        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserCreatedId = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SolvedInVersionId = table.Column<long>(type: "INTEGER", nullable: true),
                    Title = table.Column<string>(type: "TEXT", nullable: false),
                    Content = table.Column<string>(type: "TEXT", nullable: true),
                    ProjectId = table.Column<long>(type: "INTEGER", nullable: true),
                    UserCreatedId = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bugs_Versions_SolvedInVersionId",
                        column: x => x.SolvedInVersionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Features_Versions_SolvedInVersionId",
                        column: x => x.SolvedInVersionId,
                        principalTable: "Versions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bugs_SolvedInVersionId",
                table: "Bugs",
                column: "SolvedInVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Bugs_UserCreatedId",
                table: "Bugs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Features_SolvedInVersionId",
                table: "Features",
                column: "SolvedInVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Features_UserCreatedId",
                table: "Features",
                column: "UserCreatedId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Versions_UserCreatedId",
                table: "Versions",
                column: "UserCreatedId");
        }
